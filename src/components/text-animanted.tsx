...
export const TextAnimated = () => {
  return (
    <div className="absolute top-1/2 left-1/2 w-screen max-w-[100%] transform -translate-x-1/2 -translate-y-1/2 text-center text-8xl font-semibold p-4 rounded-md uppercase z-10 scale-80">
