...
export const SkillSection = () => {
  ...
  // IntersectionObserver ativa animação ao entrar na viewport,
  // mas só se ainda não tiver sido ativada por clique
  useEffect(() => {
  ...
  // Escuta evento custom para disparar animação imediatamente
  useEffect(() => {
  ...
  // Atualiza posição dos percentuais ao ficar visível e no resize
  useEffect(() => {
        ...
        {skills.map((skill, i) => {
          ...
          return (
            <div
              ...
              style={{ transitionDelay: animationByClick ? "0ms" : `${i * 300}ms` }}
              role="progressbar"
              ...
              <div className="item_in">
                ...
                <span
                  ...
                  style={{
                    ...
                    transitionDelay: animationByClick ? "0ms" : `${i * 300}ms`,
                  }}
                >
                  {skill.percent}
                </span>
