...
export const alt = "Renato Marques — Desenvolvedor Front-End | FullStack";
...
export default function Image() {
  return new ImageResponse(
    (
      ...
      >
        {/* Formas de fundo: painel teal esquerdo + painel cinza direito */}
        <svg
          width="1200"
          height="630"
        ...
        >
          {/* Painel teal com borda côncava à direita */}
          <polygon points="0,0 295,0 235,315 295,630 0,630" fill="#0bafac" />
          {/* Painel cinza claro à direita com borda côncava à esquerda */}
          {/* <polygon points="1200,0 1150,0 1100,315 1150,630 1200,630" fill="#c5c5c5" /> */}
        </svg>

        {/* Logo + label no painel teal */}
        <div
          style={{
            position: "absolute",
            left: "85px",
